...
- A 561-variable vector with time and frequency domain variables. 
- Its activity label. 
...
- Each variable vector is a row on the text file.
...
Additional vectors identifying activities performed and subject performing activities:

y_train: Activity label for recorded window in training set
y_test: Activity label for recorded window in test set
subject_train: Subject label for recorded window in training set
subject_test: Subject label for recorded window in test set
activity: Activity label for recorded window in merged data set
ID: Subject label for recorded window in merged data set
